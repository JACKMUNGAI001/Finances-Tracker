    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-border-light/60 safe-bottom">
      <div className="max-w-md mx-auto flex items-center justify-around px-2 py-2">
        ...
        >
          ...
          <span className="text-[10px] font-semibold">{t('nav_report')}</span>
        </NavLink>
        ...
        >
          ...
          <span className="text-[10px] font-semibold">{t('nav_plan')}</span>
        </NavLink>
        ...
        >
          ...
          <span className="text-[10px] font-semibold">{t('nav_settings')}</span>
        </NavLink>
      </div>
    </nav>
  );
